...
<html lang="en">
<head>
<title>Electronik Store a Ecommerce Online Shopping Category Bootstrap Responsive Website Template | Products2 :: w3layouts</title>
<!-- for-mobile-apps -->
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									...
									<img src="images/100.jpg" alt=" " class="img-responsive" />
									<img src="images/101.jpg" alt=" " class="img-responsive" />
									<img src="images/100.jpg" alt=" " class="img-responsive" />
									<img src="images/38.jpg" alt=" " class="img-responsive" /> 
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									...
									<img src="images/102.jpg" alt=" " class="img-responsive" />
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									...
									<img src="images/108.jpg" alt=" " class="img-responsive" />
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<h5><a href="single.php"> Iron </a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<p>
								...
								American heritage non stick coated sole plate
								Comes with a neon indicator
								Unique floral design with Wooden Pattern Handle
								For free home service call toll free 1800-103-5963
						...
						<div class="col-md-7 modal_body_right">
							...
							<div class="modal_body_right_cart simpleCart_shelfItem">
								...
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart">
									<input type="hidden" name="add" value="1"> 
									<input type="hidden" name="w3ls_item" value="Electronic Guitar"> 
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<p>This product does not require installation. please contact brand customer care for any product related queires.contact_us on: [ 18602661177 ]
								...
								Warranty: 12 months Power: 1000 watts. Voltage : 230V AC, 50Hz
								Includes: Vacuum cleaner, Floor and carpet brush, Multipurpose nozzle, Flexible hose pipe, Extension tubes, User manual and Demo CD
							</p>
							<div class="rating">
								<div class="rating-left">
									<img src="images/star-.png" alt=" " class="img-responsive">
					...
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<p>Brand	Vizy
								...
								Item part number	VZ-IP
								Included Components	1 MP3 player, 1 Earphone , 1 USB Cable, 1 Earphone Case pouch
								Batteries Included	Yes
								Battery Cell Composition	Lithium Polymer
								Supported Standards	MP3</p>
							<div class="rating">
								<div class="rating-left">
									<img src="images/star-.png" alt=" " class="img-responsive" />
								</div>
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<p>A convection microwave oven combines basic microwave technology with radiant heat and circulating hot air to let you roast, brown, and grill foods. Convection microwaves have a heating element as well as a fan to circulate the heated air. This results in a more thorough, even job of cooking.</p>
							<div class="rating">
								<div class="rating-left">
									<img src="images/star-.png" alt=" " class="img-responsive">
								</div>
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							<h4>Speakers</h4>
							<p>
								Processor: Intel Celeron N4000 processor, 1.1GHz base processor speed
								Operating System: Preloaded Windows 10 Home with lifetime validity
								Display: 15.6-inch HD (1366x768) display
								Memory & Storage: 4GB LPDDR4 RAM with Intel UHD 600 Graphics | Storage: 500GB HDD
								Design & battery: Laptop weight: 1.9 kg
								Warranty: This genuine Asus laptop comes with 1 year manufacturer warranty on the device and 6 months manufacturer warranty on included accessories from the date of purchase
								Preinstalled Software: Windows 10 Home | In the box: Laptop, Battery, Power cord
								Ports & CD drive: 2 USB 2.0, 1 USB 3.0, 1 HDMI, 1 audio-out
							</p>
							<div class="rating">
								<div class="rating-left">
									<img src="images/star-.png" alt=" " class="img-responsive" />
