	...
	<div class="single">
		<div class="container">
			...
			<div class="col-md-8 single-right">
				<h3>The Samsung Galaxy Note10+</h3>
				<div class="rating1">
				...
				<div class="description">
					...
					<p>Introducing next-level power

						With Galaxy Note10 and Note10+ we've designed a mobile experience that’s like a computer, a gaming console, a movie-tech camera, and an intelligent pen, all in one device.</p>
				</div>
				...
				<div class="occasional">
						...
						<div class="colr ert">
							<div class="check">
								<label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i>512 GB</label>
							</div>
				...
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						...
						<p>
								...
								Memory, Storage & SIM: 12GB RAM | 512GB internal memory expandable up to 1TB | Dual SIM dual-standby (4G+4G) - Hybrid Sim slot
					...
					<div class="tab-2 resp-tab-content additional_info_grid" aria-labelledby="tab_item-1">
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h5>Oct 06, 2019.</h5>
									<p>Just got today, it looks amazing. Hope it works the same way. Battery taking 1.5hrs to get full, I was expecting faster...
						...
						<div class="additional_info_sub_grids">
							<div class="col-xs-2 additional_info_sub_grid_left">
								<img src="images/t8.png" alt=" " class="img-responsive" />
							</div>
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<a href="single.php">Michael</a>
									<h5>Oct 04, 2019.</h5>
									<p>No dislikes.....a flagship with full of features....
											Display as usual is LOVE!!!!😍😍
											12GB RAM is insane...
											Overall it's a BEAST that no other flagship can defeat except it's SUCCESSOR.
											And One more thing No bloody hell pop-up camera....😃😃</p>
								</div>
								<div class="additional_info_sub_grid_rightr">
									<div class="rating">
										<div class="rating-left">
